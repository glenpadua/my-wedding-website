...
export default function WeddingTimeline() {
  return (
    <div className="h-full bg-white text-dusty-blue-800 flex flex-col md:flex-row items-center justify-center p-4 bg-gradient-to-b from-white to-dusty-blue-100">
